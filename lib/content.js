...
export const site = {
  ...
  bio:
    "Computing (IT) student at TU Dublin, focused on building full stack web applications. I want to build software that's clean, reliable, and useful.",
  longBio:
    "I'm a Computing (IT) student at Technological University Dublin, on track to graduate in 2027. I build full stack web applications and, I enjoy picking up whatever language or tool a project calls for. Outside of coding I'm usually at the gym, watching football, travelling or listening to music.",
  education: {
