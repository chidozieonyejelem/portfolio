...
export const site = {
  ...
  longBio:
    "I'm a Computer Science (IT) student at Technological University Dublin, working toward my BSc (2023–2027). I build full-stack web and desktop applications — among them a Next.js campus-navigation app with an interactive 3D map, a PHP and MySQL car-rental platform, and a Java desktop calculator. I'm comfortable across the stack and enjoy picking up whatever language or tool a project calls for, with a focus on writing code that's clean, well-tested, and genuinely useful. Outside of coding I'm usually at the gym, watching football, or travelling.",
  stack: ["JavaScript", "Java", "Python", "PHP", "Next.js", "React"],
};
...
export const techStack = [
  { label: "Languages", items: ["Java", "JavaScript", "Python", "PHP", "SQL", "CSS"] },
  { label: "Frameworks & Libraries", items: ["Next.js", "React", "Node.js"] },
  { label: "Databases", items: ["MySQL", "MongoDB"] },
  { label: "Tools & Platforms", items: ["Git", "GitHub", "Vercel", "AWS S3"] },
];
