...
export const selectedWork = [
  {
    ...
    year: "2025",
    href: "", // TODO: add Campus Quest link (no public repo found)
    external: true,
  },
  {
    num: "002",
...
export const techStack = [
  ...
  { label: "Databases & Backend", items: ["MySQL", "MongoDB", "Supabase"] },
  { label: "Tools & Platforms", items: ["Git", "GitHub", "Vercel", "Netlify", "AWS S3"] },
];
